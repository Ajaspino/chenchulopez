...
const translations = {
  gl: {
    ...
    'works.posters.title':    'Cartaces',
    'works.identity.title':   'Identidade',
    'works.uxui.sub':         '— Produtos dixitais',
  ...
  es: {
    ...
    'works.filter.all':       'Todos',
    'works.posters.title':    'Cartelería',
    'works.identity.title':   'Identidad',
    'works.uxui.sub':         '— Productos digitales',
